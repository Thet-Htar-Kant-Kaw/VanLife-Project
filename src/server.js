...
createServer({
    ...
    routes() {
        this.namespace = "api"  //all the requests will start with api
        this.logging = false
        this.timing= 2000

        this.get("/vans", (schema, request) => { //will handle all rqs to /api/vans
        ...
        this.get("host/vans", (scheme, request) => {
            ...
            return this.schema.vans.where({ hostId: "123"})
        })
